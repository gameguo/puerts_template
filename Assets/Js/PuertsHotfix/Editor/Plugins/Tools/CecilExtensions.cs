...
namespace Puerts
{
    static internal class CecilExtensions
    {
        ...
        static int getLDCOperand(Mono.Cecil.Cil.Instruction instrunction)
        {
            ...
            out int firstInstruction)
        {
            ...
            if (instructions.Count > 2 && instructions[1].OpCode.Code == Mono.Cecil.Cil.Code.Call)
            {
                ...
                {
                    if (instructions[i].OpCode.Code == Mono.Cecil.Cil.Code.Ret)
                    {
